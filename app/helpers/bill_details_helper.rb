module BillDetailsHelper
	def self.get_bill_details_grid_coldef
		...
		grid_header_config_arr << {"field" => "payable_amount","headerName"=>"Due Amount","width" => 175,"decoration_id"=>1}
		...
		grid_header_config_arr << {"field" => "bill_edit_date","headerName"=>"Bill Edited","width" => 190,"decoration_id"=>0}
